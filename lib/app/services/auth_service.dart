...
import 'package:employee_management/app/utils/utils.dart';
...
class AuthService extends ChangeNotifier {
  ...
  Future registerEmployee(
    ...
    try {
      ...
      if (response != null) {
        ...
        Utils.showSnackBar("Account created successfully!", context,
            color: Colors.green);
  ...
  Future loginEmployee(
    ...
    try {
      ...
      Utils.showSnackBar("Login Success!", context, color: Colors.green);
      setIsLoading = false;
    } catch (e) {
      setIsLoading = false;
      Utils.showSnackBar(
